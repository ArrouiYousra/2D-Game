...
public class LoseScreen implements Screen {
    ...
    public LoseScreen(TwoDGame game) {
        this.game = game;
    }
    ...
    public void render(float delta) {
        ...
        // Dessiner "You Lose !!!" juste en dessous du titre
        titleFont.setColor(1, 0, 0, 1); // Rouge pour la défaite
        String loseText = "You Lose !!!";
        layout.setText(titleFont, loseText);
        float loseTextX = (Gdx.graphics.getWidth() - layout.width) / 2f;
        float loseTextY = textFontY - 30; // Juste en dessous du titre
        titleFont.draw(batch, loseText, loseTextX, loseTextY);
